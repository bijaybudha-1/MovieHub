...
### Movies Section
![Movies Page Screenshot](docs/screenshots/movies-page.png)
...
### Series Details
![Series Details Screenshot](docs/screenshots/series-details.png)
...
### Rating System
![Rating System Screenshot](docs/screenshots/rating-system.png)
*Interactive 5-star rating interface*

### Watchlist
![Watchlist Screenshot](docs/screenshots/watchlist.png)
*Personal collection of saved movies and shows*

### Mobile Responsive
<div align="center">
  <img src="docs/screenshots/mobile-home.png" width="250" alt="Mobile Home"/>
  <img src="docs/screenshots/mobile-movies.png" width="250" alt="Mobile Movies"/>
  <img src="docs/screenshots/mobile-profile.png" width="250" alt="Mobile Profile"/>
</div>
...
│   │
│   ├── images/                      # Image Assets
│   │   ├── avatar-images.avif       # User avatar
│   │   ├── image.png                # Logo/Banner
│   │   └── login-bg-images.jpg      # Login background
│   │
│   └── js/                          # JavaScript Modules
│       ├── form-validation.js       # Form validation logic
│       ├── include.js               # HTML component includes
│       ├── main.js                  # Main JavaScript
│       ├── movieApi.js              # Movie API integration
│       ├── movieDetails.js          # Movie details functionality
│       ├── profile-fixed.js         # Fixed profile features
│       ├── profile.js               # Profile management
│       ├── rating.js                # Rating system
│       ├── seriesApi.js             # Series API integration
│       ├── seriesDetails.js         # Series details functionality
│       ├── slider.js                # Image slider/carousel
│       ├── tvShowsApi.js            # TV Shows API integration
│       ├── tvShowsDetails.js        # TV Shows details functionality
│
├── pages/                            # HTML Pages
│   ├── addToList.html               # Add to watchlist
│   ├── contact.html                 # Contact form
│   ├── login.html                   # User login
│   ├── movies-details.html          # Movie details page
│   ├── people.html                  # Cast & crew directory
│   ├── profile.html                 # User profile
│   ├── ratings.html                 # Ratings overview
│   ├── register.html                # User registration
│   ├── reviews.html                 # Reviews section
│   ├── series.html                  # Series listing
│   ├── seriesDetails.html           # Series details
│   ├── tv-shows.html                # TV shows listing
│   └── tvshowDetails.html           # TV show details
│
